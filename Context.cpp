...
static void createWindows(void){
	...
	glutInitWindowPosition((int)position.x, (int)position.y);
	glutInitWindowSize((int)screen.x, (int)screen.y);
	...
	textureWindow = glutCreateSubWindow(mainWindow, GAP, GAP, (int)subWidth, (int)subHeight);
	...
	worldWindow = glutCreateSubWindow(mainWindow, (int)subWidth + 2 * GAP, GAP, (int)subWidth, (int)subHeight);
